...
export const ptBR: Translations = {
    ...
    settings: {
        ...
        bitrateDisplay: (mbps: string) => `Taxa de vídeo: ${mbps} Mbps`,
        bitrateHint: "Reduza a taxa em conexões lentas. Aumente para melhorar a qualidade da imagem.",
        fps: "FPS",
        ...
        normal: "Normal",
        gamepadSettings: "Configurações do Controle",
        controller: "Controle",
