...
export const frFr: Translations = {
    ...
    settings: {
        ...
        up: "Haut",
        down: "Bas",
        resolutionAndFps: "Résolution et FPS",
        video: "Vidéo",
        bitrate: "Débit (Kbps)",
        bitrateDisplay: (mbps: string) => `Débit vidéo : ${mbps} Mbps`,
        bitrateHint: "Réduisez le débit sur les connexions lentes. Augmentez-le pour améliorer la qualité d'image.",
        fps: "Ips",
